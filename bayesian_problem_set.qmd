...
Your task is to modify the code below to estimate the posterior distribution of parameters in Q10 function that was in the likelihood analysis problem set. Use the same data as used in the Q10 likelihood exercise.
...
Provide plots of your prior distributions.
...
Randomly select 1000 values from the parameters in your posterior distribution. Show the randomly selected values for each parameter as a histogram.
